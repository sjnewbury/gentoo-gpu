...
if [[ ${PV} == 9999 ]]; then
	# AKA Amber
	EGIT_COMMIT=901e0d6a11b647069ebd1b381bd0c25741d072b3
...
PATCHES=(
	${FILESDIR}/${P}-fix-missing-openmp-include.patch
	#${FILESDIR}/${P}-meson-glvnd-gles.patch
)
...
RDEPEND="
	...
	X? ( >=media-libs/libglvnd-1.3.2[X?,${MULTILIB_USEDEP}] )
