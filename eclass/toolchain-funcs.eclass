...
tc-getNM() { tc-getPROG NM gcc-nm "$@"; }
# @FUNCTION: tc-getRANLIB
# @USAGE: [toolchain prefix]
# @RETURN: name of the archive indexer
tc-getRANLIB() { tc-getPROG RANLIB gcc-ranlib "$@"; }
...
tc-getBUILD_AR() { tc-getBUILD_PROG AR gcc-ar "$@"; }
