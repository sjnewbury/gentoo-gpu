...
IUSE="aqua coverage doc +egl +geolocation gles2 gnome-keyring +gstreamer +introspection +jit libnotify nsplugin +opengl spell wayland +webgl X system-malloc"
...
#	fi
	...
	local mycmakeargs=(
		...
		-DUSE_GSTREAMER_MPEGTS=$(usex gstreamer)
		-DUSE_GSTREAMER_GL=${gstreamer_gl}
