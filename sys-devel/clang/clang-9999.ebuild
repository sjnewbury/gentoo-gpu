...
inherit git-2 subversion eutils multilib python
...
#	ESVN_PROJECT=llvm subversion_fetch "http://llvm.org/svn/llvm-project/llvm/trunk"
	EGIT_PROJECT=llvm EGIT_REPO_URI="git://people.freedesktop.org/~tstellar/llvm" git-2_src_unpack
...
src_prepare() {
	...
	#epatch "${FILESDIR}"/revert-PrintFatalError.patch
	#epatch "${FILESDIR}"/fix-llvm_enable_dump-build.patch
